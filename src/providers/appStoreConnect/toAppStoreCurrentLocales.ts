...
function toCurrentLocale(item: AppStoreListingContext['locales'][number]): StoreListingLocale[] {
  if (item.appInfoLocalizationId === undefined || item.versionLocalizationId === undefined)
    return [];
