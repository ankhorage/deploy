...
- de215b1: Update Ankhorage dependencies: `@ankhorage/contracts`.
...
- fc93dc5: Update Ankhorage dependencies: `@ankhorage/contracts`.
...
- 14fbcec: Update Ankhorage dependencies: `@ankhorage/contracts`.
- 45fae4a: Update Ankhorage dependencies: `@ankhorage/contracts`.
...
- fb39c5f: Update Ankhorage dependencies: `@ankhorage/contracts`.

## 0.12.3

### Patch Changes

- 01249f5: Update Ankhorage dependencies: `@ankhorage/contracts`.

## 0.12.2

### Patch Changes

- 7954971: Update Ankhorage dependencies: `@ankhorage/contracts`.
...
- 9b735ec: Expose canonical project authoring APIs for store listing locales/assets, monetization products, and prepared releases so Studio and other consumers can mutate Deploy-owned desired state without duplicating authored file layout or validation.

## 0.11.0

### Minor Changes

- 5057a9a: Stabilize `ankh deploy` for CI with a versioned single-document JSON result, deterministic exit-code contract, prompt-free JSON approval semantics, action-required safety stops, transient credential redaction, and normal Ankh provider-discovery acceptance coverage.
